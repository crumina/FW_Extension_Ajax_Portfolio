...
if ( $sort_panel_type !== 'ajax' ) {
    ?>
    <nav class="portfolio-nav-numbers standard-portfolio-nav-numbers">
...
<nav class="<?php echo esc_attr( $ext->get_config( 'selectors/navLinksWrapper' ) ); ?> portfolio-nav-numbers ajax-portfolio-nav-numbers">
    <?php echo( $links ); ?>
</nav>